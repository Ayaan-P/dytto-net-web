...
export default function TreePage() {
  const { relationships, user } = useAppStore();
            ...
            >
              ...
              <svg width="100%" height="500" viewBox="0 0 800 500" className="overflow-visible">
                ...
                {relationships.slice(0, 8).map((relationship, index) => {
                  ...
                  const radius = 120 + (relationship.level * 10);
                  const x = 400 + Math.cos(angle) * radius;
                  const y = 200 + Math.sin(angle) * radius;
                  const branchColor = getLevelColor(relationship.level);
                ...
                {relationships.map((relationship) => (
                  ...
                  >
                    <div 
                      ...
                      style={{ backgroundColor: getLevelColor(relationship.level) }}
                    >
                      {relationship.level}
                    </div>
