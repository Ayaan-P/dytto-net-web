...
if ANTHROPIC_API_KEY:
    ...
    print("Warning: ANTHROPIC_API_KEY is not set. AI processing features will be disabled.")
...
def process_interaction_log_ai(interaction_log, current_level, current_categories):
    ...
    if not anthropic_client:
        print("Warning: Anthropic client not available. Using fallback analysis.")
        return "Positive interaction", 2, "AI analysis unavailable", None, None, "Continue building your relationship"
