...
if ANTHROPIC_API_KEY:
    ...
    print("Warning: ANTHROPIC_API_KEY is not set. AI insights features will be disabled.")
...
def generate_ai_emotional_summary(
    ...
    try:
        ...
        if not anthropic_client:
            print("Warning: Anthropic client not available. Using fallback emotional summary.")
            return {
                "common_tone": "Mixed",
                "tone_shift": None,
                "emotional_keywords": [],
